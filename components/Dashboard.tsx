      ...
      <div className="bg-indigo-600 dark:bg-indigo-500 p-10 rounded-[56px] text-white shadow-2xl relative overflow-hidden group">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              onClick={handleShare}
              className="p-5 bg-indigo-400/20 text-white rounded-full backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all active:scale-90"
            >
              <Share2 size={24} />
            </button>
          </div>
              ...
              <div className="p-10 space-y-10 overflow-y-auto max-h-[65vh] custom-scrollbar">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-slate-50 dark:bg-slate-800/50 p-8 rounded-[48px] border border-slate-100 dark:border-slate-700 flex flex-col items-center text-center space-y-6">
                       <div className="w-16 h-16 bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 rounded-2xl flex items-center justify-center font-black text-xl">A</div>
                       ...
                       <div className="space-y-4 w-full">
                          <div className="flex items-center gap-4 text-left">
                             ...
                             <p className="text-[11px] font-bold text-slate-500">Tap the <b className="text-indigo-600">3 Dots (⋮)</b> in corner.</p>
                          </div>
                          <div className="flex items-center gap-4 text-left">
                             ...
                             <p className="text-[11px] font-bold text-slate-500">Select <b className="text-indigo-600">"Install App"</b>.</p>
                          </div>
                       </div>
                    </div>

                    <div className="bg-slate-50 dark:bg-slate-800/50 p-8 rounded-[48px] border border-slate-100 dark:border-slate-700 flex flex-col items-center text-center space-y-6">
                       <div className="w-16 h-16 bg-rose-100 dark:bg-rose-900/40 text-rose-600 rounded-2xl flex items-center justify-center font-black text-xl">i</div>
                       ...
                       <div className="space-y-4 w-full">
                          <div className="flex items-center gap-4 text-left">
                             ...
                             <p className="text-[11px] font-bold text-slate-500">Tap the <b className="text-rose-600">Share Icon</b> (box + arrow).</p>
                          </div>
                          <div className="flex items-center gap-4 text-left">
                             ...
                             <p className="text-[11px] font-bold text-slate-500">Tap <b className="text-rose-600">"Add to Home Screen"</b>.</p>
                          </div>
                       </div>
                    </div>
                 </div>
